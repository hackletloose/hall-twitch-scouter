...
class MyView(discord.ui.View):
    ...
    async def unwanted(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_modal(await UnifiedModal.create('unwanted', self.streamer_name))
    ...
    async def certify(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_modal(await UnifiedModal.create('certify', self.streamer_name))
...
class UnifiedModal(discord.ui.Modal):
